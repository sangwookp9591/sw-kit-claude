...
import { readStateOrDefault } from '../core/state.mjs';
 ...
 * @returns {Array<object>} Merged rule set
 */
 ...
 * @param {string} [projectDir]
 * @returns {{ allowed: boolean, violations: Array<{ rule: object, match: string }> }}
 */
 ...
 * @param {Array<{ rule: object, match: string }>} violations
 * @returns {string}
 */
