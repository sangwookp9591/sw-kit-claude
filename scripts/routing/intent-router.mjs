 ...
 * @param {string} input
 * @returns {{ hasAnchor: boolean, anchorTypes: string[] }}
 */
 ...
 * @param {string} input
 * @param {{ anchorTypes: string[] }} anchorInfo
 * @returns {number} complexity score
 */
function estimateComplexity(input, anchorInfo) {
 ...
 *   preset: 'solo'|'duo'|'squad'|'full'|'design',
 *   confidence: number,
 *   reason: string,
