 ...
 */
function getHandoffDir(feature: string, projectDir?: string): string {
 ...
 */
export function writeHandoff(params: HandoffParams, projectDir?: string): HandoffWriteResult {
  ...
  try {
    ...
    log.error('Failed to write handoff', { error: (err as Error).message });
 ...
 */
export function readHandoff(feature: string, stage: string, projectDir?: string): string | null {
 ...
 */
export function listHandoffs(feature: string, projectDir?: string): HandoffListEntry[] {
  const dir = getHandoffDir(feature, projectDir);
  try {
 ...
 */
export function getResumeContext(feature: string, projectDir?: string): ResumeContext {
