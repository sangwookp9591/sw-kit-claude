 ...
 */
export const CATEGORIES: Record<string, CheckCategory> = {
 ...
 */
export function classifyResults(results: CheckResult[]): ClassifiedResults {
  ...
  const autoFix: CheckResult[] = [];
  const needsAsk: CheckResult[] = [];
 ...
 */
export function formatChecklistResults(results: CheckResult[], classified: ClassifiedResults): string {
